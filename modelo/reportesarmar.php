...
switch($array['datos']){
    case '1':{ //prestamos realizados
        ...
        $titulo="Cantidad de préstamos realizados"; //titulo del reporte
    ...
    case '2':{ //prestamos retrasados
        ...
        $from.=reportes($array['datos'], $array['tiempo']);//agrego el factor tiempo a sql
        $titulo="Cantidad de préstamos retrasados";//titulo del reporte
    ...
    case '3':{ //prestamos no devueltos
        ...
        $from.=reportes($array['datos'], $array['tiempo']);//agrego el factor tiempo a sql
        $titulo="Cantidad de préstamos no devueltos";//titulo del reporte
